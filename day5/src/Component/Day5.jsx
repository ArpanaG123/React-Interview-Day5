...
const Day5 = () => {
  return (
    <div className='main'>
        <h3>Question1:What is High Order Component in react js?</h3>
        ...
        <h3>Question2:Do you know about SEO?Is it true that react js supports SEO support?</h3>
        ...
        <h3>Question3:clean up in useEffect?</h3>
        ...
        <h3>Question4:What is the use of useCallback and useMemo?</h3>
        <p>
            useCallback Hook
            <ul>
